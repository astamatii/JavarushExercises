...
// Твоя задача — в методе main(String[]) развернуть переданную строку с помощью поля outputStream (то есть, outputStream должен хранить в себе перевернутую строку) 
// и вывести в консоли.
...
public class L6_4_PrintStream {
	...
	public static void main(String[] args) throws IOException {
		...
		printSomething(new StringBuffer(scanner.nextLine()).reverse().toString()); /* printSomething(scanner.nextLine()); */
