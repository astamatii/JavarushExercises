...
//2. Создай в классе Solution статические методы 
...
//6. Исправь 2 ошибки в методе printListValues так, 
// 	чтобы на экран корректно выводилось содержимое переданного в качестве параметра списка.
...
//8. Метод main() не учавствует в проверке, 
// 	но для отображения результата можно вызвать все новые методы и передать каждому список list.
