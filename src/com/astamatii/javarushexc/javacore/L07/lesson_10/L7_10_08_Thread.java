...
//	отображается одним блоком, без перемешивания. 
//	Так как synchronized существенно замедляет программу (на нашей маленькой программе это, скорее всего, заметно не будет), 
