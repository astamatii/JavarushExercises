...
//В класс Singleton добавь приватный метод Object readResolve(), 
// чтобы после десериализации ссылки на объекты были равны. Метод main не участвует в тестировании.

public class L10_4_Serialization_3_Singleton implements Serializable {
